...
function Index() {
  ...
  const [prefillTruckId, setPrefillTruckId] = useState<string | null>(null);
            ...
            <Card>
              <CardContent className="pt-6">
                <DayGrid
                  ...
                  onAddJob={(d, truckId) => {
                    setOpenDay(d);
                    setPrefillTruckId(truckId ?? null);
                    setEditingId(null);
                    setMode("form");
                    setDialogOpen(true);
                  }}
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto -mx-6 px-6">
                <ScheduleForm
                  ...
                  defaultTruckId={prefillTruckId ?? undefined}
                  existingJobs={jobs}
                  onSubmit={(j) => {
                    if (editingJob) {
